...
import com.test.appthemoviedb.R
import com.test.appthemoviedb.data.api.TheMovieDBClient
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rv_move_list.layoutManager = gridLayoutManager
        rv_move_list.setHasFixedSize(true)
        rv_move_list.adapter = movieAdapter
